...
* Добавлены следующие проверки в CI:
  * Проверка структуры проекта
  * Проверка JSON на валидность
  * Проверка на мусорные файлы
  * Линтер ruff для поиска ошибок в коде
* Исправлены импорты: заменён import * на явные импорты из config_engine.py
* Убраны неиспользуемые переменные (current_project, clock)
---
